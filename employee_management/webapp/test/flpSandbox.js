		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsplemployeemanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplemployeemanagement-display": {
								"semanticObject": "comibsplemployeemanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.employeemanagement",
									"url": sap.ui.require.toUrl("com/ibspl/employeemanagement")
								}
							}
						}
					}
